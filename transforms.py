...
# Transform selector
# =================================================================================================
def transform_selector(transform_string):
    if transform_string == "shape_transforms":
        transforms = shape_transforms()
        
    if transform_string == "colour_transforms":
        transforms = colour_transforms()
        
    if transform_string == "combine_transforms":
